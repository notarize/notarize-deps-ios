...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/auth0/jwt-decode", .exact("2.6.3")),
        ...
        .package(url: "https://github.com/segmentio/analytics-ios", .exact("4.5.1")),
        .package(url: "https://github.com/getsentry/sentry-cocoa", .exact("7.4.4")),
