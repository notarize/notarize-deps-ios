...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "NotarizeCV",
                      url: "https://ios-notarize-signer-sdk.s3.us-west-1.amazonaws.com/NotarizeCV-2.6.0.xcframework.zip",
                      checksum: "7503e7db9b3dc8d6270129a4e31223730b88f2a8a11f0f925769e4a26f5d612d"),
