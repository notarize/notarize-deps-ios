...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "DeviceKit",
                      url: "https://ios-notarize-signer-sdk.s3.us-west-1.amazonaws.com/DeviceKit-4.3.0.xcframework.zip",
                      checksum: "b144c163289d4ee600d82f60b79575b56a689e3b1a296e3a768bb41c0e67b753"),
