...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "NotarizeCV",
                      url: "https://ios-notarize-signer-sdk.s3.us-west-1.amazonaws.com/NotarizeCV-2.7.0.xcframework.zip",
                      checksum: "719a11fa4979795338f12a6976adc61931453f286107c99bedf81948ef7c02aa"),
