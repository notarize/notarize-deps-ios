...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "NotarizeCV",
                      url: "https://ios-notarize-signer-sdk.s3.us-west-1.amazonaws.com/NotarizeCV-2.8.0.xcframework.zip",
                      checksum: "1fc93e6d6cc350763c5966ae6d850111b0a0bea19beb1b5565cf8716827b2358"),
